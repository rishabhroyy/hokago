...
export function Row({
  ...
  return (
    <section className="mt-11">
      <div className="mb-1 flex items-baseline justify-between px-12">
        ...
        {onSeeAll && (
          <span
            className="cursor-pointer text-[12.5px] font-bold text-ink-3 transition-colors hover:text-wii-deep"
            onClick={onSeeAll}
          >
            See all →
          </span>
      ...
      <div className="group/row relative">
        <button
          ...
          className="absolute left-6 top-[calc(50%-14px)] z-[5] flex h-11 w-11 items-center justify-center rounded-full border border-white bg-white/95 text-ink opacity-0 shadow-panel backdrop-blur-sm transition-[opacity,transform,color] duration-200 ease-snap group-hover/row:opacity-100 hover:text-wii-deep active:scale-[.88]"
          onClick={() => scroll(-1)}
        >
        ...
        <div
          ref={scrollerRef}
          className="flex gap-[20px] overflow-x-auto px-12 pb-[22px] pt-6 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
        ...
        <button
          ...
          className="absolute right-6 top-[calc(50%-14px)] z-[5] flex h-11 w-11 items-center justify-center rounded-full border border-white bg-white/95 text-ink opacity-0 shadow-panel backdrop-blur-sm transition-[opacity,transform,color] duration-200 ease-snap group-hover/row:opacity-100 hover:text-wii-deep active:scale-[.88]"
          onClick={() => scroll(1)}
        >
