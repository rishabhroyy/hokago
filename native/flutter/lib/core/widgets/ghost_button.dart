  ...
  Widget build(BuildContext context) {
    return ClipRRect(
      ...
      child: BackdropFilter(
        ...
        child: Material(
          color: HokagoColors.ghostFill,
          child: InkWell(
            onTap: onPressed,
            child: Container(
              decoration: BoxDecoration(border: Border.all(color: HokagoColors.ghostBorder)),
              ...
              child: Row(
                ...
                children: [
                  ...
                  DefaultTextStyle(
                    style: TextStyle(fontFamily: 'Plus Jakarta Sans', color: HokagoColors.ink, fontSize: 14.5, fontWeight: FontWeight.w700),
                    child: child,
                  ),
                ],
              ),
