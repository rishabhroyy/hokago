 ...
 * "burn" — nothing about this type is device-specific. Chromecast is
...
export interface DeviceProfile {
 ...
 /** Force flags (evaluation order, stage 1) — default true when omitted. */
...
/**
 * Gate for the tone-map chain. Mirrors packages/scanner/src/probe.ts's
